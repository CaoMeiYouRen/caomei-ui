...
| 语言矩阵 - 中期 | 用户需求（2026-09-14） | 追加繁体中文（zh-TW）、日语（ja-JP）、韩语（ko-KR）；**范围评估见** [语言矩阵 - 中期评估记录](../design/governance/2026-09-16-language-matrix-midterm-evaluation.md)（含方案比较与待决策项，未登记 todo / roadmap） | 低 |
