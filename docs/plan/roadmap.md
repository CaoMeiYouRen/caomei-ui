...
| **Phase 6** | — | 组件库补全与规范化（momei 迁移就绪；已授权启动） | 下游使用复核与缺口清单（已完成）；设计规范 + 可验证脚本；caomei / momei 双主题预设（含暗色）；momei 缺口组件补全与关键增强（Button / DataTable 核心路径，按 [M1 台账](../design/governance/2026-09-14-momei-usage-audit.md)）；第三方许可声明 |
