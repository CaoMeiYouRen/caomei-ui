...
- Phase 0（立项与 POC）、Phase 1（Tier 0 组件）、Phase 2（Tier 1 组件）、Phase 3（Tier 2 组件）与 Phase 4（Tier 3 稳定批组件）已完成并归档；Phase 5 待规划决策启动；首版尚未发布。
...
| **Phase 5** | — | 文档站 + 首个下游接入 | 组件文档（见 [文档与演示站](../design/documentation-site.md)；组件页已随 Phase 1 / Phase 2 落地，Phase 5 聚焦搜索 / i18n / 版本化等增强）、semantic-release 发布、dependfix/platform 接入验证 |
...
> 状态：Phase 0 ~ Phase 4 已完成并归档（见 [待办归档](./todo-archive.md)）；Phase 5 待规划决策启动，见 [待办事项](./todo.md)。
