...
- Phase 0（立项与 POC）、Phase 1（Tier 0 组件）、Phase 2（Tier 1 组件）与 Phase 3（Tier 2 组件）已完成并归档；Phase 4（Tier 3 稳定批组件）已由用户决策启动；首版尚未发布。
...
- 目标组件集（按下游使用面统计）：Tier 0（9 个核心组件，已完成）+ Tier 1（含 Switch 共 8 个，已完成）+ Tier 2（6 个，已完成）+ Tier 3 稳定批（7 个，Phase 4 进行中）。
...
> 状态：Phase 0 ~ Phase 3 已完成并归档（见 [待办归档](./todo-archive.md)）；Phase 4（Tier 3 稳定批组件）已由用户决策启动，见 [待办事项](./todo.md)。
