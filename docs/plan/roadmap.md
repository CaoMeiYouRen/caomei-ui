...
- Phase 0（立项与 POC）、Phase 1（Tier 0 组件）、Phase 2（Tier 1 组件）、Phase 3（Tier 2 组件）、Phase 4（Tier 3 稳定批组件）与 Phase 5 第一阶段（文档站增强：docs 质量护栏 / 站内搜索 / 站点 i18n）已完成并归档；Phase 5 第二阶段（首版发布 / 首个下游接入）待外部前置；首版尚未发布。
...
> 状态：Phase 0 ~ Phase 4 与 Phase 5 第一阶段已完成并归档（见 [待办归档](./todo-archive.md)）；Phase 5 第二阶段（首版发布 / 首个下游接入）待用户外部前置就绪后决策，Phase 6、Phase 7 未启动。
